...
export function buildReviewPrompt({ originalQuestion, chatgptAnswer, focus, }) {
...
export function buildRevisionInstruction(originalQuestion, chatgptAnswer, reviewText) {
